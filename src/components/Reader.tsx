...
const Reader: React.FC = () => {
    const {
        ...
        parallelLanguage, parallelBibleData,
        t
    } = useAppContext();
    ...
    const parallelBook = parallelBibleData.find(b => b.id === currentBook?.id);
    const parallelChapter = parallelBook?.chapters[currentChapterIndex] || [];

    const [scrollProgress, setScrollProgress] = useState(0);

    useEffect(() => {
        const handleScroll = () => {
            const container = document.querySelector('.tab-container') || window;
    ...
    }, [currentBookIndex, currentChapterIndex, isLoadingBible, parallelLanguage]);
            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        color: 'white',
                        marginBottom: '40px',
                        boxShadow: '0 20px 50px -12px rgba(79, 70, 229, 0.5)',
                        position: 'relative',
                        overflow: 'hidden',
                        display: 'flex',
                ...
                >
                    ...
                    <Quote size={100} style={{ position: 'absolute', top: -10, left: -10, opacity: 0.07, zIndex: 0 }} />
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ width: '20px', height: '2px', backgroundColor: 'rgba(255,255,255,0.4)', borderRadius: '1px' }} />
                                        ...
                                        <div style={{ flex: 1 }}>
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    display: parallelLanguage ? 'grid' : 'block',
                                                    gridTemplateColumns: parallelLanguage ? 'repeat(auto-fit, minmax(280px, 1fr))' : 'none',
                                                    gap: '24px'
                                                }}
                                            >
                                                ...
                                                {parallelLanguage && parallelChapter[index] && (
                                                    <div style={{
                                                        opacity: 0.7,
                                                        fontSize: '0.95em',
